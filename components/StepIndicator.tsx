  ...
  return (
    <div className="w-full mb-8">
      <div className="flex justify-between items-end mb-3">
        <div>
          <span className="text-xs font-light inline-block py-1 px-2 uppercase tracking-widest text-black border border-gray-300">
            Fortschritt
          </span>
        </div>
      ...
      <div className="overflow-hidden h-0.5 mb-6 text-xs flex bg-gray-200">
        <div
      ...
      <h2 className="text-2xl font-medium text-black tracking-wide">{categoryName}</h2>
    </div>
  );
};
