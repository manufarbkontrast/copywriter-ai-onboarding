    ...
    <div className="max-w-5xl mx-auto w-full px-4 sm:px-6 py-8 animate-fade-in">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 gap-4">
        <div>
           ...
           <p className="text-sm text-gray-600 mt-2 font-light">Für: <span className="font-normal text-black">{contactData.name}</span></p>
        </div>
        <div className="flex gap-3 w-full md:w-auto">
            <button 
                onClick={copyToClipboard}
                className="flex-1 md:flex-none px-5 py-2.5 bg-black hover:bg-gray-800 text-white rounded-sm text-xs font-light tracking-wide transition-all duration-200 uppercase"
            >
                JSON Exportieren
            </button>
            <button 
                onClick={onReset}
                className="px-5 py-2.5 bg-white border border-gray-300 text-black hover:bg-gray-50 rounded-sm text-xs font-light tracking-wide transition-all duration-200 uppercase"
            >
                Neu
            </button>
        </div>
      ...
      <div className="bg-white border border-gray-200 rounded-sm p-6 mb-8">
        <h3 className="text-xs font-light text-gray-500 uppercase tracking-widest mb-5">Kundendaten</h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-sm">
            ...
            <div>
                ...
                <a href={contactData.website} target="_blank" rel="noopener noreferrer" className="text-black hover:underline truncate block font-light border-b border-transparent hover:border-black transition-all duration-200">
                    {contactData.website || "-"}
                </a>
            </div>
             <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        {/* Summary Card */}
        <div className="col-span-1 md:col-span-2 bg-black rounded-sm p-8 text-white">
          <h3 className="text-gray-300 uppercase text-xs font-light tracking-widest mb-4">Zusammenfassung</h3>
        ...
        {/* Big Idea Hook */}
        <div className="col-span-1 md:col-span-2 bg-white border-l-2 border-black rounded-sm p-8">
           <h3 className="text-gray-500 uppercase text-xs font-light tracking-widest mb-5">Big Idea Hook</h3>
        ...
        <div className="bg-white border border-gray-200 rounded-sm p-6">
          <h3 className="text-gray-500 uppercase text-xs font-light tracking-widest mb-5">Avatar Psychogramm (Vorher)</h3>
        ...
        <div className="bg-white border border-gray-200 rounded-sm p-6 flex flex-col justify-center">
           <h3 className="text-gray-500 uppercase text-xs font-light tracking-widest mb-5">Unique Mechanism</h3>
           <div className="text-center py-6 bg-gray-50 rounded-sm border border-gray-300">
             <span className="text-xl font-light text-black">{result.unique_mechanism_name}</span>
           </div>
        </div>

        {/* Story Arc */}
        <div className="col-span-1 md:col-span-2 bg-white border border-gray-200 rounded-sm p-6">
           <h3 className="text-gray-500 uppercase text-xs font-light tracking-widest mb-6">Story Arc (Die Heldenreise)</h3>
           <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
              <div className="p-5 bg-gray-50 border border-gray-200 rounded-sm">
                ...
                <p className="text-sm text-gray-700 font-light leading-relaxed">{result.story_arc.problem}</p>
              </div>
              <div className="p-5 bg-gray-100 border border-gray-300 rounded-sm">
                <h4 className="font-light text-black text-sm mb-3 tracking-wide">2. Der falsche Weg</h4>
                <p className="text-sm text-gray-700 font-light leading-relaxed">{result.story_arc.failed_way}</p>
              </div>
              <div className="p-5 bg-gray-50 border border-gray-200 rounded-sm">
                <h4 className="font-light text-black text-sm mb-3 tracking-wide">3. Die Entdeckung</h4>
                <p className="text-sm text-gray-700 font-light leading-relaxed">{result.story_arc.discovery}</p>
              </div>
              <div className="p-5 bg-gray-100 border border-gray-300 rounded-sm">
                <h4 className="font-light text-black text-sm mb-3 tracking-wide">4. Das neue Leben</h4>
                <p className="text-sm text-gray-700 font-light leading-relaxed">{result.story_arc.new_life}</p>
              </div>
           </div>
        </div>
        ...
        {/* Emotional Triggers */}
        <div className="bg-white border border-gray-200 rounded-sm p-6">
          <h3 className="text-gray-500 uppercase text-xs font-light tracking-widest mb-5">Emotionale Trigger (Cialdini)</h3>
          <ul className="space-y-4">
