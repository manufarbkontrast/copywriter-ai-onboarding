...
const ContactForm: React.FC<Props> = ({ data, onUpdate, onNext, onBack }) => {
  ...
  return (
    <div className="max-w-2xl mx-auto w-full px-4 sm:px-6 py-8">
      <div className="bg-white border border-gray-200 rounded-sm p-6 sm:p-10 animate-fade-in">
        <div className="mb-10 border-b-2 border-gray-300 pb-6">
          <h2 className="text-3xl font-medium text-black tracking-wide mb-3">Kontaktdaten</h2>
          <p className="text-sm text-gray-600 font-light">Bitte gib zuerst deine Kontaktdaten ein.</p>
        </div>
        ...
        <div className="space-y-6">
          <div>
            ...
            <input
              ...
              className="w-full px-5 py-4 border-2 border-gray-400 rounded-sm focus:ring-2 focus:ring-black focus:border-black transition-all duration-200 bg-white text-black shadow-sm"
        ...
        <div className="flex justify-between mt-10 pt-6 border-t border-gray-200">
          <button
            onClick={onBack}
            className="px-6 py-3 text-sm font-light text-gray-600 hover:text-black transition-colors duration-200 tracking-wide"
          >
            Zurück
          </button>
